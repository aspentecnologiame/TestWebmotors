...
(function () {
    ...
    Module.directive("rmDatepicker", ['rmDatepickerConfig', '$compile', '$filter', '$document',
        ...
        var link = function (scope, element, attrs, ngModel) {
            ...
            scope.isActive = {
                year: function (oDate) {
                    return oDate.getFullYear() == new Date(scope.j).getFullYear();
                },
                month: function (oDate) {
                    return oDate.getMonth() == new Date(scope.j).getMonth();
                },
                date: function (oDate) {
                    return oDate.getDate() == new Date(scope.j).getDate();
                }
            };
        ...
        var TEMPLATE =
        '<div class="rm-datepicker" ng-class="{mondayStart: mondayStart}" ng-show="show">' +
            '<div class="nav">' +
